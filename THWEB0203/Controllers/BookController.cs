...
using THWEB0203.Models;

namespace THWEB0203.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult ListBookModel()
        {
            ...
            books.Add(new Book(1, "HTML5 & CSS3 The complete ", "Author Name Book 1", "Content/Images/Book1.png"));
        ...
        {
            var books = new List<Book>();
            books.Add(new Book(1, "HTLM5 & CSS3 The complete Manual", "Author Name Book 1", "/Content/images/Book1.png"));
